...
export default function App() {
  ...
  return <div className="app"><header><div><small>OFFLINE FIRST</small><h1>工時管家</h1></div><span className="status">PWA {APP_VERSION}</span></header><main key={dataVersion}>{page}</main><BottomNavigation active={active} onChange={navigate}/></div>
}
