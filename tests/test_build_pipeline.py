...
def test_debug_build_artifact_naming():
    module = load_build_mobile()
    assert module.artifact_name("debug") == "工時管家-0.8.1-debug.apk"
    assert module.artifact_name("release") == "工時管家-0.8.1-release-unsigned.apk"
    assert module.artifact_name("release", signed=True) == "工時管家-0.8.1-release.apk"
